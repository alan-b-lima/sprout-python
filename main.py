...
def main():
    ...
    match ex, dom:
        ...
        case ("ex2", "client"): cmds.ex2.client.Handle(addr)
        case ("ex2", "server"): cmds.ex2.server.Handle(addr)

        case ("ex4", "client"): cmds.ex4.client.Handle(addr)
        case ("ex4", "server"): cmds.ex4.server.Handle(addr)

        case ("ex10", "client"): cmds.ex10.client.Handle(addr, name)
        case ("ex10", "server"): cmds.ex10.server.Handle(addr)
